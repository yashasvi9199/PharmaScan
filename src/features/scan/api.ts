 ...
 */
export async function uploadScanFile(file: File | Blob, filename = "scan.jpg", metadata?: Record<string, string | number | boolean>): Promise<ScanResponse> {
  const form = buildScanForm(file as File, filename, metadata && Object.fromEntries(
